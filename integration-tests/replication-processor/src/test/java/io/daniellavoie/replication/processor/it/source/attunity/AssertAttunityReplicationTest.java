package io.daniellavoie.replication.processor.it.source.attunity;
...
public class AssertAttunityReplicationTest extends AbstractReplicationTest {
	...
	private void configureReplicationDefinition() throws IOException {
		...
		SinkDefinition sinkDefinition = new SinkDefinition("sql-server", SinkDefinition.Type.JDBC, 1,
				buildSinkConfigs(environment));

		ReplicationDefinition replicationDefinition = new ReplicationDefinition("test-attunity",
	...
	public String getSourceTopic() {
		return attunitySourceConfiguration.getName();
	}
